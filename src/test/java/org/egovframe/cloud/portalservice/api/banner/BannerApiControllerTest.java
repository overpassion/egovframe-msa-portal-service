...
class BannerApiControllerTest {
    ...
    private final String URL_ADDR_PREFIX = "http://localhost:800";
    ...
    void 배너_페이지_목록_조회() {
        ...
        assertThat(page.getContent())
                .isNotEmpty()
                .has(new Condition<>(l -> (BANNER_TITLE_PREFIX + "_10").equals(l.get(0).getBannerTitle()), "BannerApiControllerTest.findPage contains " + BANNER_TITLE_PREFIX + "_10"))
                .has(new Condition<>(l -> (BANNER_TITLE_PREFIX + "_9").equals(l.get(1).getBannerTitle()), "BannerApiControllerTest.findPage contains " + BANNER_TITLE_PREFIX + "_9"));
